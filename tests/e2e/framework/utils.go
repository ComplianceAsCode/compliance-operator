...
func (f *Framework) WaitForPrometheusMetricTargets() ([]promv1.Target, error) {
	...
	timeouterr := wait.Poll(RetryInterval, Timeout, func() (bool, error) {
		...
		podOverridesMap := map[string]interface{}{
				...
				"containers": []map[string]interface{}{
					{
						...
						"command": []string{"bash", "-c", prometheusCommand},
						"securityContext": map[string]interface{}{
		...
		podOverridesBytes, _ := json.Marshal(podOverridesMap)
		podOverrides := string(podOverridesBytes)
