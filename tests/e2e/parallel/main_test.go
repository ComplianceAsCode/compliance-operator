...
// TestSTIGProfileVersionConsistency verifies that versioned (e.g., ocp4-stig-v2r3) and
// non-versioned (e.g., ocp4-stig) STIG profiles produce identical compliance scan results.
func TestSTIGProfileVersionConsistency(t *testing.T) {
	t.Parallel()
	f := framework.Global

	t.Log("Testing STIG profile version consistency between ocp4-stig and ocp4-stig-v2r3")
	...
	baseProfiles := profileSet{
		name:            "base",
		platformProfile: "ocp4-stig",
		nodeProfile:     "ocp4-stig-node",
	}

	versionedProfiles := profileSet{
		name:            "versioned",
		platformProfile: "ocp4-stig-v2r3",
		nodeProfile:     "ocp4-stig-node-v2r3",
	}
	...
	// Summary
	t.Logf("Successfully verified %d scan pairs between base and versioned STIG profiles", matchedPairs)
	t.Log("✓ STIG profile versions produce consistent results")
}