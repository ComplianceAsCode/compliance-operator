...
.PHONY: e2e
e2e: e2e-set-image prep-e2e e2e-parallel e2e-deployment e2e-test-wait e2e-serial e2e-moderate-profiles## Run full end-to-end tests that exercise content on an operational cluster.
